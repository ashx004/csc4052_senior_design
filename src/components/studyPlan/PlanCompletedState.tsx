  ...
  return (
    <div className="mt-8 rounded-2xl bg-white p-8 text-center">
      ...
      <button
        type="button"
        onClick={onAddMore}
        className="mx-auto mt-3 flex items-center gap-1.5 rounded-full border border-gray-light bg-white px-4 py-2 text-sm font-medium text-navy hover:bg-beige-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-navy"
      >
